...
When defining the generator and likelihood functions, the input variable types must not be
specified because they are assigned automatically by the package based on the value of the
